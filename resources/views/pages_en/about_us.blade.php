	...
	<div class="container-fluid">
		<div class="mvv statements">
			<div class="row mission" style="background:#ffaa8b;">
				<div class="col-xs-12">
					<h2 class="text-center chivo black">Mission</h2>
			...
			<div class="row vision" style="background:#cc886f;">
				<div class="col-xs-12">
					<h2 class="text-center chivo black">Vision</h2>
			...
			<div class="row values" style="background:#F0A083;">
				<div class="col-xs-12">
					<h2 class="text-center chivo black">Values</h2>
					...
					<br><br>
					<a href="/"><button class="chivo styled-button mvv">Go back to our main page</button></a>
				</div>
			</div>
		</div>
	</div>
