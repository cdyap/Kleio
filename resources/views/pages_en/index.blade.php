...
<body class="body">
	...
	<div id="landing" class="row">
		<div class="col-xs-12 col-md-6 over">
			...
			<br>
			<br>
			<p style="font-size:0.8em"><span class="over-text">View this website in <a href="http://manila-star.ru/" target="_new" class="language-link">Russian</a> or <a href="/ar" class="language-link">Arabic</a></span></p>
		</div>
